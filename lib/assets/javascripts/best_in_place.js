...
BestInPlaceEditor.prototype = {
  ...
  update : function() {
    var editor = this;
    if (this.formType in {"input":1, "textarea":1} && this.getValue() == this.oldValue && !self.forceUpdate)
  ...
  initOptions : function() {
    ...
    self.element.parents().each(function(){
      ...
      self.forceUpdate   = self.forceUpdate !== undefined ? self.forceUpdate : $parent.attr("data-force-update");
    });
    ...
    self.forceUpdate       = self.element.attr("data-force-update") !== undefined ? self.element.attr("data-force-update") : self.forceUpdate;
